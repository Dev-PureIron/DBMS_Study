...
CREATE TABLE TBL_MIDDLE(
	MIDDLE_ID NUMBER CONSTRAINT PK_MIDDLE PRIMARY KEY,
	MIDDLE_IDENTIFICATION VARCHAR2(1000) CONSTRAINT UK_MIDDLE UNIQUE,
	MIDDLE_NAME VARCHAR2(1000) CONSTRAINT REQUIER_MIDDLE_NAME NOT NULL);
--	MIDDLE_MAJOR VARCHAR2(1000) CONSTRAINT REQUIER_MAJOR NOT NULL
--	MIDDLE_GENDER CHAR(1) DEFAULT 'N' CONSTRAINT BAN_CHAR CHECK(STUDENT_GENDER IN('M', 'F', 'N'))
--	STUDENT_BIRTH DATE CONSTRAINT BAN_DATE CHECK (STDUENT_BIRTH >= TO_DATE('1985-01-01', 'YYYY-MM-DD')) CONSTRAINT REQUIER_BIRTH NOT NULL
);

DROP TABLE TBL_MIDDLE;
