...
VALUES(1, '하늘색', '정육면체', '장미', '노란색');

INSERT INTO TBL_POT
(POT_ID, POT_COLOR, POT_SHAPE, FLOWER_NAME, FLOWER_COLOR)
VALUES(2, '검정색', '삼각형', '장미', '노란색');

INSERT INTO TBL_POT
(POT_ID, POT_COLOR, POT_SHAPE, FLOWER_NAME, FLOWER_COLOR)
VALUES(3, '빨간색', '벽돌집', '장미', '노란색');
...
INSERT INTO TBL_PET
(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME,OWNER_NUMBER)
VALUES(SEQ_PET.NEXTVAL, '강아지', '톰', 1, '슬개골 골절', 1);
...
INSERT INTO TBL_PET
(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME,OWNER_NUMBER)
VALUES(SEQ_PET.NEXTVAL, '원숭이', '킹콩', 3, '목', 2);
